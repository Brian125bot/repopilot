...
export const badgeVariants = cva(
  'inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 whitespace-nowrap',
  {
    variants: {
      variant: {
        ...
        indigo: 'border-transparent bg-indigo-50 text-indigo-700 border-indigo-200',
      },
    },
    defaultVariants: {
      variant: 'default',
