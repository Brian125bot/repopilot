...
\`${targetBranch}\`
${lockedSha ? `Audited head SHA: \`${lockedSha}\` — if the live head differs, re-evaluate before remediating.` : 'Audited head SHA: missing — re-evaluate to lock the audited commit before remediating.'}
